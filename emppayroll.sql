...
insert  into employee_payroll(name,salary, start) values
	('Pratik',600000.0,'2021-02-06'),
	('Tushar',400000.0,'2021-04-06'),
	('Anirudh',400000.0,'2021-04-06');
...
SELECT * FROM employee_payroll
WHERE START BETWEEN CAST('2021-02-06' AS DATE) AND DATE(NOW());
